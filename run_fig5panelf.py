...
shutil.copy(inputs_folder+"/external_inputs_DGnoiseIdentical"+str(isi_noiseDG)+".lzma",save_folder+"/external_inputs/external_inputs_DGnoise.lzma")
...
weights_inputs_neurons["DGnoiseIdentical"+str(isi_noiseDG)+"_to_pyr_ca3"]= [[1e-05*isi_noise*isi_noiseDG*2.0,1e-05*isi_noise*isi_noiseDG*2.0/10.0]]
delay_inputs_neurons["DGnoiseIdentical"+str(isi_noiseDG)+"_to_pyr_ca3"]  = [0.0,0.0]
syn_inputs_neurons["DGnoiseIdentical"+str(isi_noiseDG)+"_to_pyr_ca3"]    = [["Adend1AMPA_dgreg","Adend1NMDA_dgreg"]]
nsyns_inputs_neurons["DGnoiseIdentical"+str(isi_noiseDG)+"_to_pyr_ca3"]  = [1]
