...
#define factor _p[2]
#define factor_columnindex 2
#define ik _p[3]
#define ik_columnindex 3
#define qinf _p[4]
#define qinf_columnindex 4
#define tauq _p[5]
#define tauq_columnindex 5
#define q _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 gskch /home/dimitrios/TFM/CA1model/mechanisms/gskch.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Calcium-activated potassium channel";
...
static int  rates ( _threadargsprotocomma_ double _lca ) {
   double _lalpha , _lsum ;
 _lalpha = factor * _lca * _lca ;
   _lsum = _lalpha + beta ;
   tauq = 1.0 / _lsum ;
   qinf = _lalpha / _lsum ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dimitrios/TFM/CA1model/mechanisms/gskch.mod";
static const char* nmodl_file_text = 
