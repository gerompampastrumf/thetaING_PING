...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 ch_KvCaB /home/dimitrios/TFM/CA1model/mechanisms/ch_KvCaB.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 92 in file ch_KvCaB.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dimitrios/TFM/CA1model/mechanisms/ch_KvCaB.mod";
static const char* nmodl_file_text = 
