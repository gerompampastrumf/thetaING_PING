...
#define dt _nt->_dt
#define freq _p[0]
#define freq_columnindex 0
#define del _p[1]
#define del_columnindex 1
#define dur _p[2]
#define dur_columnindex 2
#define amp _p[3]
#define amp_columnindex 3
#define baseamp _p[4]
#define baseamp_columnindex 4
#define i _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 sinstim /home/dimitrios/TFM/CA1model/mechanisms/SIN.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dimitrios/TFM/CA1model/mechanisms/SIN.mod";
static const char* nmodl_file_text = 
