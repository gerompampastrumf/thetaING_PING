#RUNS the theta-ING/theta-PING transition given a seed (input1=[1,20])
#and a multiplier for the PC->BC strength
...
pyr_bas = [0.0,40,80][input2]

n_ec_neurons=500
noise_bas = 4.0
noise_bas_neg = [1.2,1.5,2.0,5.0,10.0][-1]
ec_bas = [0.0,0.125,0.25,0.375,0.5][4]
